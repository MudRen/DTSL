...
void give_reward_questjob(object ob,object target)
{
   ...
   exp=150+target->query("reward_exp");
   pot=50+target->query("reward_pot");
   silver=ob->query("max_pot");
...
void give_reward_killerjob(object ob)
{
    ...
    exp=120+random(30)+lev*10;
    pot=100+random(20)+lev*3;
...
if (who->query("combat_exp") >=200000)
{
  ...
  exp=300+random(30)+lev*10;
  pot=210+random(20)+lev*3;
...
if (who->query("combat_exp") >=200000)
{
 lev=who->query_temp("yaojob/level");
  exp=350+random(30)+lev*10;
  pot=220+random(20)+lev*3;
