...
string *MjC = ({"",
                ...
                "1 ´º","2 ÏÄ","3 Çï","4 ¶¬","1 Ã·","2 À¼","3 Öñ","4 ¾Õ","°µ  "
              });
int K;
string Tc = "";
//×ÊÁÏ
...
"@j" : ({ "Èþ°µ¿Ì", 2 }),"@H" : ({ "¶þ  ¿Ú", 2 }),"@k" : ({ "Èþ  ×Ó", 2 }),"@B" : ({ "´ºÏÄÇï¶¬", 2 }),
...
/////////////
        ...
        for (i=0; i<26; i++) Mj+="  ";
        Mj+="[1;36;46m  [0m\n";
        Mj+="[1;36;46m  [0;36m¡õ    "+HIW+"ÖÐ[0mÎÄÃû×Ö  [1mÒÑ[0mÍæ¾ÖÊý  [1m×Ü[0mÕ½¼£  [1m×Ô[0mÃþ´ÎÊý  [1m·Å[0mÇ¹´ÎÊý[1;36;46m¡õ[0m\n";
        for (i=0;i<Play;i++){
            if (Play==4) winner=get_mjdata(NowPlayerId[i]);
            Mj+=sprintf("[1;36;46m  [0;36m¡õ[1;37m%12s  [33m%8d  [35m%6d  [32m%8d  [34m%8d[1;36;46m¡õ[0m\n",
...
int show_top(string str)
{
        ...
        show+=HBWHT+"  \n";
        show+="  "+HBRED+"¡õ Ó¢ÎÄÃû×Ö ©¦  ÖÐÎÄÃû×Ö  ©¦ÒÑÍæ¾ÖÊý©¦ ×ÜÕ½¼£ ©¦×ÔÃþ´ÎÊý©¦·ÅÇ¹´ÎÊý  "+HBWHT+"  \n";
        if (str=="all"){
           for (i=0; i<sizeof(MjData); i+=6){///
               show+="  "+HBRED;
               show+=sprintf("¡õ%10s©¦%12s©¦%8s©¦%8s©¦%8s©¦%8s  ",
