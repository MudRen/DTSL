...
void create()
{
	...
	set("vendor_goods", ({
		"/d/zhiye/obj/kuangshi1",
		"/d/zhiye/obj/kuangshi2",
		"/d/zhiye/obj/kuangshi3",
		"/d/zhiye/obj/kuangshi4",
...
int check(object ob)
{
	...
	if( !objectp(ob)
	 ...
	 || strsrch(room_name, "/d/wiz/") == 0
	 || strsrch(room_name, "/d/slwg/") == 0
	 || strsrch(room_name, "/d/death/") == 0
	 || strsrch(room_name, "/d/biwu/") == 0
	 || strsrch(room_name, "/d/npc/") == 0
	 || strsrch(room_name, "/d/obj/") == 0
	 || strsrch(room_name, "/d/newbie/") == 0
	 || strsrch(room_name, "/d/job/") == 0
	 || strsrch(room_name, "/d/quest/") == 0
