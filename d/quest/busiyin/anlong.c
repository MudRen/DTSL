...
void create()
{
   set_name("°²Â¡",({ "an long","an","long"}) );
        set("gender", "ÄÐÐÔ" );
        set("age", 52);
        set("str",30);
        set("title",HIY"ÌìÁ«×ÚÖ÷"NOR);
        set("long","ÕâÊÇÐ°½ÌµÄÒ»´ó¸ßÊÖ¡£\n");
