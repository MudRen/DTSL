...
void create()
{
   set_name("旦梅",({ "dan mei","dan" }) );
        set("gender", "女性" );		
        set("age", 24);
        set("nickname","银发魔女");
        set("per",24);
   set("long", "她是阴癸教主座下四魅之一，长着一头银发。\n");
   ...
   carry_object(__DIR__"obj/jinxiuqun")->wear();
...
int accept_object(object who,object obj)
{
   ...
   return notify_fail("这样东西给我不太合适，你还去找林士宏吧！\n");
   who->set_temp("bai_yingui/step2",1);
   tell_object(who,query("name")+"娇媚地一笑：原来是郑兄推荐来的人才，好，好！！\n"+
   "如果你不嫌弃，就拜我为师吧！\n");
   return 1;
}
