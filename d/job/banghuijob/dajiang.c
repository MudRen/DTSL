...
void create()
{
   set_name("铁心",({ "tie xin","tie","xin" }) );
        set("gender", "男性" );
        set("title","大江联执法堂堂主");
        set("nickname",HIR"杀绝叛徒"NOR);
        set("age", 32);
   set("long", "这是大江联执法堂堂主，专门处理叛徒。\n");
