...
int exert(object me, object target)
{
	...
	if(!me->query_skill("bihai-force",1))
		return notify_fail("不学碧海神功如何使用「火」？\n");
	...
	msg=HIR"$N"+HIR+"深吸一口气，待到呼出之时，双目已经射出闪电般的光芒！\n"NOR;
	message_vision(msg,me);
	me->set_temp("exert_bihaiforce",1);
	me->add_temp("apply/dodge",me->query_skill("bihai-force",1)/3);
