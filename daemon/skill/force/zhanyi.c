...
int exert(object me, object target)
{
	...
	if(target!=me)
			return notify_fail("「战意」不能用来攻击别人！\n");
	...
	if(!me->query_skill("tiangang-sanjue",1))
		return notify_fail("不学天罡三诀如何使用「战意」？\n");
	...
	me->add("force",-200);
        ...
        msg=HIR"$N"+HIR+"纵声一啸，只见双目设出两道精光，身法顿时快捷无比！\n"NOR;
	message_vision(msg,me);
	me->set_temp("exert_tiangangsanjue",1);
	me->add_temp("apply/dodge",me->query_skill("tiangang-sanjue",1)/3);
