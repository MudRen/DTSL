...
int main(object me,string arg)
{
        ...
        for(i=0;i<sizeof(weapons)&&i<number;i++){
         ...
         msg +="最大伤害:"+weapons[i]->query("weapon_prop/damage")+"\n";
         msg +="最小伤害:"+weapons[i]->query("weapon_prop/min_damage")+"\n";
         msg +="附加命中:"+weapons[i]->query("weapon_prop/dodge")+"\n";
         msg +="附加防御:"+weapons[i]->query("weapon_prop/armor")+"\n";
         msg +="附加最小伤害:"+weapons[i]->query("weapon_prop/enhance_min_damage")+"\n";
         msg +="附加最大伤害:"+weapons[i]->query("weapon_prop/enhance_max_damage")+"\n";
         msg +="叠加伤害:"+weapons[i]->query("weapon_prop/double_damage")+"\n";
         msg +="增加臂力:"+weapons[i]->query("weapon_prop/strength")+"\n";
         msg +="增加悟性:"+weapons[i]->query("weapon_prop/intelligence")+"\n";
         msg +="增加根骨:"+weapons[i]->query("weapon_prop/constitution")+"\n";
         msg +="增加身法:"+weapons[i]->query("weapon_prop/dodgeaction")+"\n";
         msg +="增加容貌:"+weapons[i]->query("weapon_prop/personality")+"\n";
         msg +=HIR"是否无内力要求:"NOR+weapons[i]->query("weapon_prop/no_need_force")+"\n";
         msg +=HIR"是否无内力上限要求:"NOR+weapons[i]->query("weapon_prop/no_need_maxforce")+"\n";
         msg +=HIR"是否无属性要求:"NOR+weapons[i]->query("weapon_prop/no_need_sx")+"\n";
         msg +="装备需求降低内力:"+weapons[i]->query("weapon_prop/reduce_force")+"\n";
         msg +="装备需求降低内力上限:"+weapons[i]->query("weapon_prop/reduce_maxforce")+"\n";
         msg +="装备需求降低属性要求:"+weapons[i]->query("weapon_prop/reduce_sx")+"\n";
         msg +="后天锻炼伤害"+weapons[i]->query("user_skill")/10+"\n";
