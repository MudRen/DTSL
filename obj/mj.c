...
void create()
{
set_name("À×¾ÅÖ¸",({"lei jiuzhi","lei","jiuzhi"}));
        
        set("age",30+random(10));
        set("gender","ÄÐÐÔ");
        set("long","Õâ¾ÍÊÇÈË³Æ¡°±±À×ÄÏÏã¡±ÖÐµÄ±±À×¡£\n");
        set("inquiry",([
           "mj": (: to_say_play :),
           "Âé½«": (: to_say_play :),
           "Íæ·¨": (: to_say_play :),
...
write(@HELP
    ...
    ©¦   topmj   topmh aip,topmj -p,topmj -w,topmj -h,topmj -d  ©¦
    ©¦         topmj -l¿´È«²¿,-lw,-lh,-ld¡£               ²é×ÊÁÏ©¦
    ©¸©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¼
HELP);
        return 1;
}
