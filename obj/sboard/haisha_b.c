...
void create()
{
        set_name("海沙帮英雄榜", ({ "yingxiong bang","bang" }) );
        set("location", "/d/haisha/juyipeng");
...
int do_appoint(string arg)
{
   ...
   if(me->query("shili/leader")!="haisha_b")
   return notify_fail("你不是海沙帮的帮主，没有这个权利！\n");
