...
void create()
{
        set_name("大江联英雄榜", ({ "yingxiong bang","bang" }) );
        set("location", "/d/dajianglian/juyiting");
...
int do_appoint(string arg)
{
   ...
   if(me->query("shili/leader")!="dajiang_b")
   return notify_fail("你不是大江联的盟主，没有这个权利。\n");
